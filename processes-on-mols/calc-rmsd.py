...
def process_molecules(precise_path, rdkit_3d_path, optimized_3d_path, structure_2d_path):
...
if __name__ == '__main__':
    # Paths to SDF files
    precise_path = 'data/gdb7/gdb7.sdf'
    rdkit_3d_path = 'data/gdb7-3d/gdb7.sdf'
    optimized_3d_path = 'data/gdb7-3d-opt/gdb7.sdf'
    structure_2d_path = 'data/gdb7-2d/gdb7.sdf'

    # Process the molecules and calculate RMSD
    rmsd_df = process_molecules(precise_path, rdkit_3d_path, optimized_3d_path, structure_2d_path)

    # Save the results to a CSV file
    logging.info("Saving results to a CSV file...")
    rmsd_df.to_csv('data/rmsd-qm7.csv', index=False)
