...
def main():
    ...
    wandb_logger = WandbLogger(name=args.job_id+"-baseline-0.8", project='pre-training-via-denoising', notes=args.wandb_notes, settings=wandb.Settings(start_method='thread', code_dir="."))
